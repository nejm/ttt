...
myApp.directive('jsPlumbCanvas', function ($rootScope) {
    ...
    var def = {
        ...
        transclude: true,
        template: '<div  id="canvas" ng-transclude></div>',
...
//            });
            instance.bind("connection", function (info, origEvent) {
                ...
                if (typeof origEvent !== 'undefined' && origEvent.type == 'drop') {
                    ...
                    console.log("connection000000",$rootScope.connections);
                    //console.log("T&S",targetUUID, sourceUUID);
